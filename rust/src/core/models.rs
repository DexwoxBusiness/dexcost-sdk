...
impl Task {
    ...
    pub fn to_dict(&self) -> serde_json::Value {
        serde_json::json!({
            ...
            "status": self.status,
            "started_at": self.started_at.to_rfc3339_opts(chrono::SecondsFormat::Micros, true),
            "ended_at": self.ended_at.map(|t| t.to_rfc3339_opts(chrono::SecondsFormat::Micros, true)),
            ...
            "llm_cost_usd": self.llm_cost_usd.normalize().to_string(),
            "external_cost_usd": self.external_cost_usd.normalize().to_string(),
            "compute_cost_usd": self.compute_cost_usd.normalize().to_string(),
            "total_cost_usd": self.total_cost_usd.normalize().to_string(),
            "total_input_tokens": self.total_input_tokens,
            "total_output_tokens": self.total_output_tokens,
            "total_cached_tokens": self.total_cached_tokens,
            "retry_count": self.retry_count,
            "retry_cost_usd": self.retry_cost_usd.normalize().to_string(),
            ...
            "network_cost_usd": self.network_cost_usd.normalize().to_string(),
            "gpu_cost_usd": self.gpu_cost_usd.normalize().to_string(),
...
impl CostEvent {
    ...
    pub fn to_dict(&self) -> serde_json::Value {
        serde_json::json!({
            ...
            "occurred_at": self.occurred_at.to_rfc3339_opts(chrono::SecondsFormat::Micros, true),
            "cost_usd": self.cost_usd.normalize().to_string(),
